 ...
 */
        ...
        //bagımsiz if cumleleri veya if-else ile çozulebilir
        // ikisininde artıları ve eksikleri var
        //biz bagimsiz if kullanmayı tercih ettik

        boolean kontrol=true;

        if (!(sifre.charAt(0)>='a' && sifre.charAt(0)<='z' )){
            System.out.println("kucuk kucuk harf ile baslamali");
            kontrol=false;
        }
