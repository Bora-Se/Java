...
public class C03_AsalsayiKontrol {
    public static void main(String[] args) {
        ...
        // 25457 2==> 25456'ya kadar her hangi bir sayiya bolunursa // asal olmadigini anliyoruz
        // bunu Javanin da anlamasini saglayalim,bunu javanin anlamasi icin bir bayrak kullanabiliriz
        ...
        // burada nasil bir sonuc yazilmali; asal iken mi ? asal degilken mi ?
        if (flagAsalMi){
