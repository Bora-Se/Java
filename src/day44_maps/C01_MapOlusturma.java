...
public class C01_MapOlusturma {
    public static void main(String[] args) {
        ...
        // Genelde virgul kullanilir ama biz - kullanalim.
        System.out.println(ogrenciMap);

        // Bilgiler arasinda  "-" kullaninca; {101=Ali-Can-10-H-MF, 102=Veli-Cem-11-M-Soz}
        // Virgul kullansaydik: {101=Ali, Can, 10, H, MF, 102=Veli, Cem, 11, M, Soz}
