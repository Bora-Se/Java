...
public class C01_Ternary {
    public static void main(String[] args) {
      ...
      seceneklerinden uygun olani yazdirin. Sayi pozitif degilse,
      ...
      */
        ...
        String sonuc= sayi>0 ?                                            //sart
            (sayi%2==0 ? "Cift sayi" : "Cift sayi degil"):  //sart dogru ise calısacak kod
            (sayi<=-100 && sayi>=999 ? "3 basamakli" : "3 basamaklı degil" ); //sart dogru degilse calisacak kod
