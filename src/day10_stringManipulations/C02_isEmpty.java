...
public class C02_isEmpty {
    ...
    public static void main(String[] args) {
        ...
        /* Java'da null pointer diye bir isaretci var. null pointer bir deger degildir
        ...
        1. ya null ile isaretleriz
        String str4=null;
        java yazdirdiginizda bunun null oldugunu yazdirir ama baska bir method calistirmak isterseniz RTE verir

        2. veya sadece deklare eder, deger atamayiz
        String str5;
        ne yazdirabilirsiniz, ne de herhangi bir kodda kullanabilirsiniz bu variable'i yazarsaniz java CTE verir*/
