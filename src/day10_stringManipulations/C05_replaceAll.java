...
public class C05_replaceAll {
    public static void main(String[] args) {
        ...
        // eger metin'deki rakamlardan kurtulmak istersek//3 kere replace yapmamiz gerekir
        str=str.replace("1","");
        str=str.replace("2","");
        str=str.replace("3","");
        ...
        /* replaceAll method'u tek tek String'leri degil de tum sayilari, tum bosluklari,tum harfleri...
        gibi ortak ozellikle tanimlanabilecek karakterin hepsini toptan degistirmek icin kullanilir */
