...
public class C03_Scope {
  ...
  /*variable'lar instance oldugundan (non static) main method icerisinden direk ulasamayiz
         -- static method icerisinde instance variable'lara ulasmak istyerseniz
          ...
          degisirse tum class uyeleri icin degismis olur okulun ismi veya adresi gibi
