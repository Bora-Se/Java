...
public class C02_Runner {
   ...
   /* 1-bir class'dan baska bir class'daki static variable ve method'lara ulasmak icin
     classismi.variableIsmi yazmak yeterlidir. 2-bir class'dan baska bir class'daki
     instance variable'lara erismek icin object olusturmamiz lazim */
